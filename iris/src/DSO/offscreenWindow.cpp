...
#define GL_IMPLEMENTATION_COLOR_READ_FORMAT 0x8B9B
    ...
    ////////////////////////////////////////////////////////////////////////
    class offscreenWindow : public iris::Augment
    {
    public:
	offscreenWindow():iris::Augment("offscreenWindow") 
	{

	    setDescription("%s- a simple offscreen window",getName()) ;

	    _window = new iris::Window("offscreen") ;
	    ...
	    iris::SceneGraph::instance()->control("AFTER REALIZE DSO offscreenWindow cycle") ;
...
{
    return new offscreenWindow::offscreenWindow ;
}
