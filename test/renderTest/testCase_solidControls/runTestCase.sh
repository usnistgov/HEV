...
#echo Timeline: `locate solidControls.timeline.iris`   # Debug
...
# Generate new images
irisfly --background 1 1 1 --ex desktopWindowTraits512.iris solid.iris solidControls.timeline.iris  >  $LOG 2>&1 
