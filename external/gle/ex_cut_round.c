...
draw_cut_style_cap_callback (int iloop,
                                  ...
                                  int frontwards)
{
/* JGH: Do same thing for GL_32 and USER_OUTPUT_CALLS */
#if defined(GL_32) | defined (USER_OUTPUT_CALLS)
/* #ifdef GL_32 */
   int i;
#endif /* GL_32 */
                           ...
                           gleDouble xform_array[][2][3])   /* 2D contour xforms */
{
   ...
   /* JGH: added initialization of isect_point to get rid of bogus compilation
      warning. */
