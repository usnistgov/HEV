...
"O3,2,4,1\n"           // set tracker 3 "hand1" output configuration 
"O4,2,4,1\n"           // set tracker 4 "hand2" output configuration 
"ML0\n"                // turn off blue LEDs
"SC\n";                // set continuous spew
...
IS900::IS900(void) 
{
  ...
  tracker_shm[2] = new dtkSharedMem(6*sizeof(float), "hand1");
  tracker_shm[3] = new dtkSharedMem(6*sizeof(float), "hand2");
  ...
  if(tracker_shm[0]->isInvalid() || tracker_shm[1]->isInvalid() ||
     tracker_shm[2]->isInvalid() || tracker_shm[3]->isInvalid() ||
