...
for run in "./dtk-udpEchoWriter localhost:22712" \
"dtk-readStrings udpEcho --queue --count" \
"dtk-server -v udpEcho --argument=22712"
do
...
echo
echo "TYPE INTO THE TOP WINDOW AND <ENTER>"
echo
