...
class drivingForceGT : public dtkService
{
public:
	drivingForceGT(void);
	~drivingForceGT(void);
...
drivingForceGT::drivingForceGT(void) :
	valuatorShm(sizeof(float)*3, "drivingForceGT/valuator")
{
	...
	if(fd < 0)
		dtkMsg.add(DTKMSG_ERROR,
				"drivingForceGT::drivingForceGT() failed find a good"
				" Logitech (TM) Driving Force GT device on any USB port.\n");
}
