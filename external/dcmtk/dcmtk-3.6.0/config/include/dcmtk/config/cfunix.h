...
#define DCMTK_PREFIX "/usr/local/HEV/external/dcmtk"

/* Define the default data dictionary path for the dcmdata library package. */
#define DCM_DICT_DEFAULT_PATH "/usr/local/HEV/external/dcmtk/share/dcmtk/dicom.dic"

/* Define the default directory where configuration files reside. */
#define DEFAULT_CONFIGURATION_DIR "/usr/local/HEV/external/dcmtk/etc/dcmtk/"

/* Define the default directory where support data files reside. */
#define DEFAULT_SUPPORT_DATA_DIR "/usr/local/HEV/external/dcmtk/share/dcmtk/"
